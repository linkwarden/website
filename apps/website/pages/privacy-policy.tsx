  ...
  return (
    <div className="flex flex-col gap-5 max-w-xl mx-auto p-2 mt-20">
      ...
      <ul className="list-disc">
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Linkwarden, the web
      ...
      <ul className="list-disc">
        ...
        <li>
          <p>State, Province, ZIP/Postal code, City</p>
        </li>
        <li>
          <p>Usage Data (For the website only: https://linkwarden.app)</p>
        </li>
      </ul>
      ...
      <h2 className="text-2xl">Usage, Performance and Miscellaneous</h2>
      <p>
      ...
      <h1 className="text-3xl">GDPR Privacy</h1>
      ...
      <h2 className="text-2xl">Your Rights under the GDPR</h2>
      <p>
      ...
      <h2 className="text-2xl">Categories of Personal Information Collected</h2>
      <p>
      ...
      <h2 className="text-2xl">Sources of Personal Information</h2>
      <p>
      ...
      <h2 className="text-2xl">Use of Personal Information</h2>
      <p>
      ...
      <h2 className="text-2xl">Disclosure of Personal Information</h2>
      <p>
      ...
      <h2 className="text-2xl">Share of Personal Information</h2>
      <p>
      ...
      <h2 className="text-2xl">Sale of Personal Information</h2>
      <p>
      ...
      <h2 className="text-2xl">Your Rights under the CCPA/CPRA</h2>
      <p>
      ...
      <h2 className="text-2xl">Do Not Sell My Personal Information</h2>
      <p>
        As defined in the CCPA/CPRA, &quot;sell&quot; and &quot;sale&quot; mean
        selling, renting, releasing, disclosing, disseminating, making
        available, transferring, or otherwise communicating orally, in writing,
      ...
      <h3 className="text-xl">Mobile Devices</h3>
      <p>
