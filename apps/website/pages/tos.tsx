    ...
    <div>
      ...
      <div className="flex flex-col gap-5 max-w-xl mx-auto p-2 mt-20">
        ...
        <ul className="list-disc">
          <li>
            <p>
              ...
              the Company, used by You on any electronic device, named
              Linkwarden
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Linkwarden.
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          ...
          our copyright agent via email at support@linkwarden.app and include in
        ...
        <p>
          ...
          support@linkwarden.app. Upon receipt of a notification, the Company
        ...
        <p>
          You may not use the Linkwarden Services for any illegal or
          ...
          the laws of Canada and the Province of Ontario. You will comply with
          all applicable laws, rules and regulations (including but not limited
          to obtaining and complying with the requirements of any license or
          permit that may be necessary to operate your store or that may be held
          by you) in your use of the Service and your performance of obligations
