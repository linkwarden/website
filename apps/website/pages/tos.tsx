...
export default function TOS() {
  return (
    <div className="flex flex-col gap-5 max-w-xl mx-auto p-2 mt-20">
      ...
      <p className="text-3xl">Interpretation and Definitions</p>
      ...
      <ul className="list-disc">
        <li>
          <p>
            <strong>Application</strong> means the web appliction provided by
            the Company, used by You on any electronic device, named Linkwarden
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Linkwarden.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Linkwarden, accessible from{" "}
            <a
              href="cloud.linkwarden.app"
      ...
      <p className="text-3xl">Acknowledgment</p>
      <p>
      ...
      <p className="text-2xl">Subscription period</p>
      <p>
      ...
      <p className="text-2xl">Subscription cancellations</p>
      <p>
      ...
      <p>
        ...
        information including full name, zip code, email, and a valid payment
        method information.
      </p>
      <p>
      ...
      <p className="text-2xl">Fee Changes</p>
      <p>
      ...
      <p className="text-2xl">Refunds</p>
      <p>
      ...
      <p className="text-3xl">User Accounts</p>
      <p>
      ...
      <p className="text-2xl">Your Right to Post Content</p>
      <p>
      ...
      <p className="text-2xl">Content Restrictions</p>
      <p>
      ...
      <p className="text-2xl">Content Backups</p>
      <p>
        Although backups of Content are performed, the Company does not
      ...
      <p className="text-3xl">Copyright Policy</p>
      <p className="text-2xl">Intellectual Property Infringement</p>
      <p>
      ...
      <p>
        ...
        copyright agent via email at support@linkwarden.app and include in Your
      ...
      <p>
        You can contact our copyright agent via email at support@linkwarden.app.
      ...
      <p className="text-3xl">Intellectual Property</p>
      <p>
      ...
      <p className="text-3xl">Your Feedback to Us</p>
      <p>
      ...
      <p className="text-3xl">Links to Other Websites</p>
      <p>
      ...
      <p className="text-3xl">Termination</p>
      <p>
      ...
      <p className="text-3xl">Limitation of Liability</p>
      <p>
      ...
      <p className="text-3xl">Governing Law</p>
      <p>
      ...
      <p className="text-3xl">Disputes Resolution</p>
      <p>
      ...
      <p className="text-3xl">For European Union (EU) Users</p>
      <p>
      ...
      <p className="text-3xl">Canada Legal Compliance</p>
      <p>
        The Terms of Service will be governed by and interpreted in accordance
      ...
      <p>
        You may not use the Linkwarden Services for any illegal or unauthorized
        ...
        rules and regulations (including but not limited to obtaining and
        complying with the requirements of any license or permit that may be
        necessary to operate your store or that may be held by you) in your use
        of the Service and your performance of obligations under the Terms of
        Service.
      </p>
      <p className="text-3xl">Severability and Waiver</p>
      ...
      <p className="text-3xl">Translation Interpretation</p>
      <p>
      ...
      <p className="text-3xl">Changes to These Terms and Conditions</p>
      <p>
      ...
      <ul className="list-disc">
        <li>By email: support@linkwarden.app</li>
      </ul>
    </div>
  );
}
