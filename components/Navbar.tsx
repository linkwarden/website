...
export default function Navbar() {
  ...
  return (
    <>
      <div
        className={`w-full z-30 backdrop-blur-xl fixed top-0 bg-[#111111] ${
          isMenuOpen
            ? "bg-opacity-100 min-[991px]:bg-opacity-50"
            : "bg-opacity-50"
        } flex gap-7 items-center justify-between p-2 max-w-7xl mx-auto`}
      >
        ...
        <div className="items-center gap-5 hidden min-[991px]:flex">
          ...
          >
            ...
            <p>{Math.round((ghStars / 1000) * 10) / 10}k</p>
          </Link>
          <Link
